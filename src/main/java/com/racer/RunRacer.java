...
import com.racer.racerModel.ActionPckg.ActionBlue;
import com.racer.racerModel.ActionPckg.ActionFucsia;
import com.racer.racerModel.ActionPckg.ActionGreen;
import com.racer.racerModel.ActionPckg.ActionOrange;
import com.racer.racerModel.ActionPckg.ActionRed;
import com.racer.racerModel.ActionPckg.ActionYellow;
...
public class RunRacer {
	...
	public static void main(String[] args) {
		...
		rb.getActionDice().getActions().add(new ActionOrange(
				"El jugador que lanzó el dado no avanza ni retrocede. El jugador de del turno siguiente deberá responder una pregunta. Si contesta bien, dicho jugador avanza el número obtenido en el dado num�rico. Si contesta mal, dicho jugador retrocede esa cantidad de casillas. ",
